--- THIS FILE HAS BEEN MODIFIED, ORIGINAL PLUGIN: https://github.com/dedukun/relative-motions.yazi
-- stylua: ignore
...
local render_numbers = ya.sync(function(_, mode)
	...
	Entity.number = function(_, index, total, file, hovered)
		...
		if hovered == index then
			return ui.Span(string.format(" " .. num_format .. " ", idx)) -- Space before and after
		else
			return ui.Span(string.format(" " .. num_format, idx)) -- Just space before
		end
	end
